  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <search-selector @trademarkInfo="trademarkInfo" @attrInfo="attrInfo" />
...
import SearchSelector from "./childComponent/SearchSelector/SearchSelector";
export default {
  name: "Search",
